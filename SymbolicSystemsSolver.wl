...
solveInTermsOfRaw[equs_,solveFor_,with_,allVars_]:=Module[{elim,equs2,ans},
...
extractVariablesFrom[z_]:=Module[{h,u},
h=ToString[Head[z]];
...
solveInTermsOf[equs_,solveFor_,known_]:=Module[{w,v},
...
useTemplatedEquation[base_,reps_]:=Module[{ou},
...
multipleTemplatedEquations[bases_,reps_]:=Module[{ou,n},
(*bases is a list*)
...
multipleTemplatedReplacements[bases_,repList_]:=Module[{ou},
